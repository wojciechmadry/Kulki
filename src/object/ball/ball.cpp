...
[[nodiscard]] sf::Color ball::sf_color(const COLOR Color, const short alpha) noexcept
{
    ...
    return {
            a_color[ColorNumber][0],
            a_color[ColorNumber][1],
...
void ball::random() noexcept
{
    ...
    m_colorID = static_cast<COLOR>(randomizer::get().generate<unsigned char>(0, 5));
}